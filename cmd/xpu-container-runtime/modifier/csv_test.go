...
func TestExperimentalModifier(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			description: "modification removes existing xpu-container-runtime-hook",
			spec: &specs.Spec{
				Hooks: &specs.Hooks{
					Prestart: []specs.Hook{
						{
							Path: "/path/to/xpu-container-runtime-hook",
							Args: []string{"/path/to/xpu-container-runtime-hook", "prestart"},
						},
					},
				},
			},
		...
		{
			description: "modification removes existing xpu-container-toolkit",
			spec: &specs.Spec{
				Hooks: &specs.Hooks{
					Prestart: []specs.Hook{
						{
							Path: "/path/to/xpu-container-toolkit",
							Args: []string{"/path/to/xpu-container-toolkit", "prestart"},
						},
					},
				},
			},
