...
const (
	nvidiaRuntime            = "xpu-container-runtime"
	nvidiaHook               = "xpu-container-runtime-hook"
...
// case 1) xpu-container-runtime run --bundle
// case 2) xpu-container-runtime create --bundle
...
// case 1) xpu-container-runtime run --bundle <bundle-name> <ctr-name>
//		- Confirm the runtime runs with no errors
// case 2) xpu-container-runtime create --bundle <bundle-name> <ctr-name>
...
func addNVIDIAHook(spec *specs.Spec) error {
	var argv = []string{"argv"}
	m := modifier.NewStableRuntimeModifier(logger.Logger, argv)
