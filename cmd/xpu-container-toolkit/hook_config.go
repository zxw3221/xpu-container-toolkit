...
const (
	configPath = "/etc/xpu-container-runtime/config.toml"
...
// CLIConfig : options for xpu-container-cli.
...
// HookConfig : options for the xpu-container-toolkit.
type HookConfig struct {
	...
	NvidiaContainerCLI     CLIConfig            `toml:"xpu-container-cli"`
	NVIDIAContainerRuntime config.RuntimeConfig `toml:"xpu-container-runtime"`
}
